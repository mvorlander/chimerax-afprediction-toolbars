...
```text
toolshed install /Users/yourname/Downloads/chimerax_afpredictiontoolbars-1.3.20-py3-none-any.whl
```

```text
toolshed install C:\Users\yourname\Downloads\chimerax_afpredictiontoolbars-1.3.20-py3-none-any.whl
```
...
```text
toolshed install /path/to/chimerax_afpredictiontoolbars-1.3.20-py3-none-any.whl reinstall true
```
