...
```text
toolshed install /Users/yourname/Downloads/ChimeraX_AFPredictionToolbars-1.3.16-py3-none-any.whl
```

```text
toolshed install C:\Users\yourname\Downloads\ChimeraX_AFPredictionToolbars-1.3.16-py3-none-any.whl
```
...
```text
toolshed install /path/to/ChimeraX_AFPredictionToolbars-1.3.16-py3-none-any.whl reinstall true
```
